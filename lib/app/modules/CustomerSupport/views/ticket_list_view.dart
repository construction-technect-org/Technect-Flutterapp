...
class TicketListView extends StatelessWidget {
  final CustomerSupportController controller = Get.find<CustomerSupportController>();
...
List<Ticket> convertSupportTicketsToTickets(List<SupportMyTickets> myTickets) {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(ticket.company,
                          style:
                              MyTexts.regular14.copyWith(color: MyColors.darkGray)),
                      SizedBox(width: 3.w),
                  ...
                  SizedBox(height: 1.h),
                  Text("Created: ${ticket.createdDate}   •   Updated: ${ticket.updatedDate}",
                      style:
                          MyTexts.regular14.copyWith(color: MyColors.darkGray)),
