...
class VrmAccountBillsScreen extends GetView<VrmTaskController> {
  const VrmAccountBillsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => VrmCommonLeadScreen(
        ...
        leads: controller.filteredAccountBills,
        ...
        statusWidget: VrmCommonStatusWidget(
          statusList: controller.billStatus,
          activeStatus: controller.activeBillsStatusFilter.value,
          onStatusTap: (label) => controller.setAccountStatusBillsFilter(label),
        ),
        topSpacing: 15,
      ),
    );
