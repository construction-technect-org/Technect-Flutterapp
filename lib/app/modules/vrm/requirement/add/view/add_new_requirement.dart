                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Unit of Measure"),
                          ),
                          const Gap(20),
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Customer Name"),
                          ),
                          const Gap(20),
                          CommonDropdown(
                            ...
                            itemLabel: (item) => item,
                            validator: (val) => Validate.validateNull(val, "Customer Type"),
                          ),
                          const Gap(20),
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Customer ID"),
                          ),
                          const Gap(20),
                          ...
                          CommonTextField(
                            ...
                            readOnly: true,
                            onTap: () => controller.openPhoneNumberBottomSheet(),
                                      ...
                                      .map<Widget>(
                                        (number) => Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(number, style: MyTexts.medium14),
                          ...
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Product Name"),
                          ),
                          const Gap(20),
                          ...
                          CommonTextField(
                            ...
                            // readOnly: true,
                            validator: (val) => Validate.validateNull(val, "Product Code"),
                          ),
                          const Gap(20),
                          ...
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Contacted Person"),
                          ),
                          const Gap(20),
                          ...
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Reference"),
                          ),
                          const Gap(20),
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateIndianMobileNumber(val),
                          ),
                          const Gap(20),
                          ...
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Site Location"),
                          ),
                          const Gap(20),
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Company Name"),
                          ),
                          const Gap(20),
                          ...
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Company Address"),
                          ),
                          const Gap(20),
                          CommonTextField(
                            ...
                            validator: (val) => Validate.validateNull(val, "Contact Person"),
                          ),
                          const Gap(20),
                          CommonTextField(
