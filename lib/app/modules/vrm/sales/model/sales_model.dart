...
class AllSalesModel {
  ...
  AllSalesModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? AllSales.fromJson(json['data']) : null;
  }
...
class AllSales {
  List<SaleLeads>? leads;
  Pagination? pagination;

  AllSales({this.leads, this.pagination});

  AllSales.fromJson(Map<String, dynamic> json) {
    if (json['leads'] != null) {
      leads = <SaleLeads>[];
      json['leads'].forEach((v) {
        leads!.add(SaleLeads.fromJson(v));
      });
    }
