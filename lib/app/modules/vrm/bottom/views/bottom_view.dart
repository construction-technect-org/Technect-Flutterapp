...
import 'package:construction_technect/app/modules/vrm/chat/views/vrm_chat.dart';
import 'package:construction_technect/app/modules/vrm/dashboard/views/vrm_dashboard.dart';
import 'package:construction_technect/app/modules/vrm/lead_dashboard/mainDashboard/views/lead_dashboard_screen.dart';
...
class VRMBottomBarView extends GetView<VRMBottomController> {
  ...
  Widget _getCurrentScreen() {
    switch (controller.currentIndex.value) {
      case 0:
        return VrmDashboardScreen();
      case 1:
        return const VrmLeadDashboardScreen();
      case 2:
        return const VrmChat();
      case 3:
