...
import 'package:construction_technect/app/modules/CRM/lead_dashboard/accounts/accountDetail/controller/account_lead_detail_controller.dart';
import 'package:intl/intl.dart';

class AccountLeadDetailScreen extends GetView<AccountLeadDetailController> {
  const AccountLeadDetailScreen({super.key});
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Text(
                                    Get.find<AccountsController>().activeFilter.value,
  ...
  int getCurrentPipelineStage(AccountLeads lead) {
  ...
  int getCurrentPipelineSubStage(AccountLeads lead) {
    switch (lead.salesLeadsStage) {
      case "lead":
