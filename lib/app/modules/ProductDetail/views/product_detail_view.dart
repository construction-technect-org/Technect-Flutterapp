  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Obx(
          () {
            Map<String, dynamic> filterValues = jsonDecode(controller.product.value.filterValues??'');
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildPriceRow("Product Rate:", '${controller.product.value.price??0}'),
                          SizedBox(height: 0.8.h),
                          _buildPriceRow("GST (${controller.product.value.gstPercentage??0}%):", '${controller.product.value.gstAmount}'),
