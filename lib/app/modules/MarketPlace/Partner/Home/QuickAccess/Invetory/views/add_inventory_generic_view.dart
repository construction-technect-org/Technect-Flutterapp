...
class AddInventoryGenericView extends GetView<AddInventoryController> {
  const AddInventoryGenericView({super.key});
  ...
  Widget build(BuildContext context) {
    return LoaderWrapper(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Add Generic Service", style: MyTexts.medium18),
          centerTitle: true,
        ),
        body: Obx(
            ...
            child: Column(
              ...
              children: [
                ...
                CommonTextField(
                  ...
                  hintText: "Unit * (e.g. per hour, per sqft)",
                ),
                const Gap(12),
                CommonTextField(
                  controller: controller.referenceUrlController,
                ...
                SizedBox(
                  ...
                  child: RoundedButton(
                    buttonName: "Add Service to Inventory",
