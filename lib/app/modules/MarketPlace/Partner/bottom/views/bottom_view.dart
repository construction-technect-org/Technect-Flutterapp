            ...
            child: Center(
              child: Row(
                ...
                children: [
                  ...
                  bottomBar(Asset.category, 'Category', onTap: () {}),
                  Center(child: SvgPicture.asset(Asset.center, height: 34, width: 34)),
                  bottomBar(Asset.connection, 'Connection'),
                  bottomBar(Asset.more, 'Mote'),
                ],
              ),
            ),
          ),
