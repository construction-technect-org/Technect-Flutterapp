...
class SupportRequestService {
  ...
  static Future<AddRoleModel?> addFeedback({required int rating, required String text}) async {
    try {
  ...
  static Future<UpdatedRoleModel?> updateRole({
    ...
    try {
      ...
      if (response != null) {
        ...
        return UpdatedRoleModel(success: false, data: null, message: "Null response from server");
      }
    } catch (e) {
      log("❌ Update Error: $e");
