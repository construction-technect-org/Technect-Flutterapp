...
import 'package:construction_technect/app/modules/MarketPlace/Connector/Support/RequestDemo/service/connector_request_demo_service.dart';
...
class ConnectorRequestDemoController extends GetxController {
  ...
  Future<void> addRequestDemo() async {
    ...
    try {
      ...
      final result = await ConnectorRequestDemoService.addRequestDemo(
