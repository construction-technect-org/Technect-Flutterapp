...
class ConnectorCustomerSupportController extends GetxController {
  ...
  Future<void> _loadTicketsFromStorage() async {
    final cachedTicketsModel = myPref.getConnectorSupportTicketsModel();
  ...
  Future<void> fetchMyTickets() async {
    try {
      ...
      if (result.success == true) {
        ...
        myPref.setConnectorSupportTicketsModel(result);
      } else {
