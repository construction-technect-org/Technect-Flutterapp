...
class ConnectorSupportRequestScreen extends GetView<ConnectorSupportRequestController> {
  @override
    ...
    return LoaderWrapper(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          appBar: CommonAppBar(isCenter: false, title: const Text("Support Request")),
          body: Obx(() {
                          ...
                          Row(
                            children: [
                              ...
                              _buildChip(
                                ...
                                borderColor: _getPriorityColor(ticket.priorityName ?? ""),
                                icon: _getPriorityIcon(ticket.priorityName ?? ""),
                              ),
                            ],
                          ),
                          SizedBox(height: 1.h),
