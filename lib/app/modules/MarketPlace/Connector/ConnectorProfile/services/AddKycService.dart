...
class AddKycService {
  ...
  Future<AddKycModel> connectorAddKYC({String? aadhaar, String? panCard}) async {
    try {
      final data = {"aadhaar_number": aadhaar ?? "", "pan_number": panCard ?? ""};
      final response = await apiManager.postObject(url: APIConstants.connectorCreate, body: data);
