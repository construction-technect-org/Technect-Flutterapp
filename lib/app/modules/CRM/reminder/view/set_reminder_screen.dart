          ...
          children: [
                  ...
                  Obx(
                    () => TableCalendar(
                      ...
                      daysOfWeekStyle: DaysOfWeekStyle(
                        weekendStyle: TextStyle(color: Colors.indigo.shade700),
                        weekdayStyle: TextStyle(color: Colors.indigo.shade700),
                      ),
            ...
            Row(
              ...
              children: [
                Obx(
                  () =>
                      _infoBox(label: "Date", value: c.formattedSelectedDate()),
                ),
                Obx(
                  () =>
                      _infoBox(label: "Time", value: c.formattedSelectedTime()),
                ),
              ],
            ),
