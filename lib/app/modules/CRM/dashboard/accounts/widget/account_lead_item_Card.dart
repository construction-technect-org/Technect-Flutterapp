...
class AccountItemCard extends StatelessWidget {
  ...
  void _openConversationMenu(BuildContext context, Offset position, AccountLeads lead) {
    showMenu(
      context: context,
  ...
  void _openLastConversationSheet(AccountLeads lead) {
  ...
  void _openNextConversationSheet(AccountLeads lead) {
  ...
  Widget _userInfo(AccountLeads lead) {
    return Row(
      children: [
        CircleAvatar(
          radius: 18,
