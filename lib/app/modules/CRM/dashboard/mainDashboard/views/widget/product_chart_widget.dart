...
class ProductChartWidget extends GetView<CRMDashboardController> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Obx(
                () =>
                    _legendDot('Product B', Colors.red, controller.showB.value, controller.toggleB),
              ),
            ],
          ),
  ...
  Widget _legendDot(String label, Color color, bool visible, VoidCallback onTap) {
  ...
  LineChartData _buildChartData(List<double> a, List<double> b, bool showA, bool showB) {
    final List<FlSpot> spotsA = List.generate(a.length, (i) => FlSpot(i.toDouble(), a[i]));
    final List<FlSpot> spotsB = List.generate(b.length, (i) => FlSpot(i.toDouble(), b[i]));
    ...
    return LineChartData(
      gridData: FlGridData(
        ...
        verticalInterval: 1,
        getDrawingHorizontalLine: (value) => const FlLine(strokeWidth: 0.2, dashArray: [4, 4]),
        getDrawingVerticalLine: (value) => const FlLine(strokeWidth: 0.2, dashArray: [4, 4]),
      ),
        ...
        touchTooltipData: LineTouchTooltipData(
          ...
          getTooltipItems: (touchedSpots) => touchedSpots.map((t) {
            return LineTooltipItem(
              '\$${t.y.toInt()}K',
              const TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 8),
            );
          }).toList(),
        ),
      ),
